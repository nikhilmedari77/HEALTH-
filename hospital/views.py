...
def contactus_view(request):
    ...
    if request.method == 'POST':
        ...
        if sub.is_valid():
            ...
            # Also send feedback email to the user's email address
            feedback_subject = "Feedback from Contact Us Page"
            feedback_message = f"Name: {name}\nEmail: {email}\nMessage: {message}"
            send_mail(feedback_subject, feedback_message, settings.EMAIL_HOST_USER, [email], fail_silently=False)
